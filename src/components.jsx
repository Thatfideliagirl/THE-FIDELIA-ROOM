      ...
      <section id="how" className="px-8 md:px-16 py-28" style={{ background: "#F0E7D6" }}>
        <div className="max-w-[1500px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          <Reveal>
            ...
            <div className="grid grid-cols-1 gap-8">{[{ n: "01", t: "Create Account", d: "Sign up with your basic information." }, { n: "02", t: "Choose Your Course", d: "Pick a course and answer its application questions." }, { n: "03", t: "Application Review", d: "Reviewed by the Room. Status shows Pending Review." }, { n: "04", t: "Receive Your Code", d: "Once approved, keep an eye on your email for your code." }, { n: "05", t: "Enter Code & Join", d: "Verify your code and step straight into your dashboard." }].map((s, i) => <Reveal key={i} delay={i * 80}><div className="flex items-start gap-4"><div className="f-code text-[15px] shrink-0" style={{ color: "#B8912E", fontWeight: 600 }}>{s.n}</div><div><div className="f-display text-[19px] mb-1" style={{ fontWeight: 700 }}>{s.t}</div><div className="text-[14px]" style={{ color: "#71675A" }}>{s.d}</div></div></div></Reveal>)}</div>
          </Reveal>
